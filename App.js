...
import {StyleSheet,Text,View,Image, Button, ScrollView,TextInput, TouchableHighlight,TouchableOpacity,TouchableWithoutFeedback,Switch} from 'react-native';
  ...
  return (
   ...
   <View style={styles.container}>
    ...
    <TextInput
     ...
     <TouchableHighlight onPress={handleCange}>
